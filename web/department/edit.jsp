                ...
                <span class="span12">
                    ...
                    <div class="box">
                        ...
                        <div class="box-content">
                            <form  class="form-horizontal" onsubmit="EditDepartment()">
                                <div class="control-group">
                                    <label for="textfield" class="control-label">اسم الإدارة</label>
                                    <div class="controls">
                                        <input type="hidden" id="id" value="${id}"/>
                                        <input type="text" name="name" id="name" class="input-xlarge" value="${name}">
                                        <span class="help-block" style="color: red" id="display"></span>
                                    </div>
                                </div>
