...
(function(e) {
    e.extend(e.fn, {validate: function(t) {
        ...
        }, messages: {file:"req",required: "أدخل بيانات هذا الحقل", remote: "Please fix this field.", email: "أدخل عنوان البريد الالكترونى صحيح", url: "Please enter a valid URL.", date: "أدخل التاريخ بصغية صحيحة", dateISO: "أدخل التاريخ بصيغة صحيحة", number: "أدخل ارقام فقط", digits: "Please enter only digits.", creditcard: "Please enter a valid credit card number.", equalTo: "Please enter the same value again.", maxlength: e.validator.format("عدد الاحرف المسموح بها لا تزيد عن {0}"), minlength: e.validator.format("عدد اﻷحرف المسموح بها لا تقل عن {0}"), rangelength: e.validator.format("Please enter a value between {0} and {1} characters long."), range: e.validator.format("Please enter a value between {0} and {1}."), max: e.validator.format("Please enter a value less than or equal to {0}."), min: e.validator.format("ادخل القيمة أكبر من او يساوى {0}")}, autoCreateRanges: !1, prototype: {init: function() {
                function r(t) {
